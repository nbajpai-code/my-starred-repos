...
|------------|-------------|--------------|
| **daily-arXiv-ai-enhanced** | Auto-crawl & AI summarization | Covers cs.CV, cs.GR, cs.CL, cs.AI daily |
| **ArxivDigest** | Personalized recommendations | GPT-powered relevancy ratings, email digests |
| **DailyArXiv** | Keyword-based tracking | Max 100 papers per keyword, email notifications |
| **awesome-daily-AI-arxiv** | AI/NLP/CV/Robotics digest | Dynamic updates, paper navigation |
| **arxiv-paper-curator** | Research assistant system | Production-grade RAG system |
...
|------------|------------|----------|
| **LLM + RL** | WindyLab/LLM-RL-Papers | Cross-research on LLM & RL for control |
| **LLM + AIOps** | awesome-LLM-AIOps | Academic & industrial materials |
| **RLHF** | awesome-RLHF | Reinforcement Learning from Human Feedback |
| **Deep RL** | awesome-deep-rl | Deep reinforcement learning resources |
| **RL Environments** | awesome-rl-envs | Curated RL environments |
...
- **sig-mlops** (CDF Foundation) - MLOps principles and definitions
...
1. **"Navigating MLOps"** (March 2025) - MLOps maturity, lifecycle, tools, careers
2. **"A Multivocal Review of MLOps"** (April 2025) - 33 reviews, 1,397 primary studies
3. **"MLOps: Overview, Definition, and Architecture"** (arXiv:2205.02302)
4. **"A Survey of AIOps in the Era of LLMs"** (June 2025) - Time series, logs, LLM generalization
...
#### Classic Collections
- **awesome-deep-learning-papers** (terryum) - Most cited DL papers (2012-2016)
- **Deep-Learning-Papers-Reading-Roadmap** (floodsung) - Structured learning path
- **awesome-ai-research-papers** - Seminal papers in AI/ML/NLP/CV/RL/Ethics

#### Research Areas
| Domain | Repository | Focus |
|--------|------------|-------|
| **Scientific ML** | awesome-scientific-machine-learning | SciML papers & resources |
| **ML Systems** | ml-systems-papers | Production ML architectures |
| **Surveys** | ml-surveys | Survey papers on ML topics |
| **Applied ML** | applied-ml | Tech blogs & practical papers |

#### Learning Resources
- **annotated_deep_learning_paper_implementations** (labmlai) - Code implementations
- **ml-engineering** (stas00) - ML Engineering guides
- **machine-learning-systems-design** (chiphuyen) - Systems design patterns
...
- **pwc** (zziz) - Papers sorted by GitHub stars
...
- **yzhao062/anomaly-detection-resources** - Anomaly detection papers
...
#### Computer Vision
- **extreme-assistant/CVPR2024-Paper-Code-Interpretation** - CVPR 2024 with code
- **amusi/CVPR2025-Papers-with-Code** - CVPR 2025 tracking
- **52CV/ICCV-2023-Papers** - ICCV 2023 papers
- **Vincentqyw/cv-arxiv-daily** - Daily CV arXiv tracker

#### Natural Language Processing
- **zhengziqiang/NLP-Paper** - NLP papers collection
- **iwangjian/Paper-Reading** - AI papers (NLP, RecSys, KG)

#### Graph Neural Networks
- **naganandy/graph-based-deep-learning-literature** - Daily GNN papers
...
- **rasbt/deeplearning-models** - DL architectures reference
...
#### Stanford University
- **stanford-crfm/helm** - Holistic LLM Evaluation
- **stanford-futuredata/FrugalGPT** - Cost-efficient LLM usage

#### MIT
- **mit-han-lab/streaming-llm** - Efficient streaming inference

#### CMU
- **cmu-delphi/covidcast** - COVID-19 indicators
- **CMU-Perceptual-Computing-Lab/openpose** - Keypoint detection

#### UC Berkeley
- **berkeley-abc/abc** - Logic synthesis
- **ucbrise/clipper** - Model serving

#### ML Foundations
- **mlfoundations/open_clip** - OpenCLIP
- **mlfoundations/open_flamingo** - FLAMINGO implementation

#### EleutherAI
- **EleutherAI/gpt-neox** - GPT-NeoX implementation
...
- **arXiv Vanity** - Clean paper rendering
- **CatalyzeX** - Browser extension linking papers to code

### Learning Platforms
- **Papers with Code** - paperswithcode.com
- **Hugging Face Papers** - huggingface.co/papers
- **DAIR.AI** - dair.ai
- **Weights & Biases Reports** - wandb.ai/fully-connected

### Community
- **r/MachineLearning** - Reddit community
- **Twitter/X ML** - Follow @_akhaliq, @hardmaru, @karpathy
- **Discord Servers** - Hugging Face, EleutherAI, Stability AI
- **Slack Communities** - MLOps Community, dair.ai
