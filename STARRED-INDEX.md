...
| Category | Count | Jump Link |
|----------|-------|-----------|
| 🤖 **AI & Machine Learning** | 360+ | [Jump →](#-ai--machine-learning) |
| 🤖 **MLOps Platforms** | 115+ | [Jump →](#-mlops-platforms) |
| 🤖 **AIOps** | 10+ | [Jump →](#-aiops---ai-for-it-operations) |
| 🔐 **Cybersecurity** | 132+ | [Jump →](#-cybersecurity--devsecops) |
| ☁️ **Cloud Infrastructure** | 23+ | [Jump →](#️-cloud-infrastructure) |
| 🌐 **Networking & Observability** | 131+ | [Jump →](#-networking--observability) |
| 🔀 **Networking Protocols** | 50+ | [Jump →](#-networking-protocols) |
| ☸️ **Cloud Native & CNCF** | 100+ | [Jump →](#️-cloud-native--cncf) |
...
- [NVIDIA/Megatron-LM](https://github.com/NVIDIA/Megatron-LM) - Large-scale language model training
- [NVIDIA/NeMo](https://github.com/NVIDIA/NeMo) - Conversational AI toolkit
- [NVIDIA/TensorRT-LLM](https://github.com/NVIDIA/TensorRT-LLM) - High-performance LLM inference
- [NVIDIA/DeepLearningExamples](https://github.com/NVIDIA/DeepLearningExamples) - Deep learning examples
- [NVIDIA/apex](https://github.com/NVIDIA/apex) - PyTorch extensions for mixed precision
- [NVIDIA/cutlass](https://github.com/NVIDIA/cutlass) - CUDA templates for linear algebra
- [NVIDIA/nccl](https://github.com/NVIDIA/nccl) - Multi-GPU communication library
- [NVIDIA/cuDNN](https://github.com/NVIDIA/cudnn-frontend) - Deep neural network library
- [NVIDIA/Triton](https://github.com/triton-inference-server/server) - Inference serving software

**NVIDIA Research:**
- [NVIDIA/StyleGAN3](https://github.com/NVlabs/stylegan3) - Generative adversarial networks
- [NVIDIA/instant-ngp](https://github.com/NVlabs/instant-ngp) - Neural graphics primitives
- [NVIDIA/Neuralangelo](https://github.com/NVlabs/neuralangelo) - 3D reconstruction
- [NVIDIA/kaolin](https://github.com/NVlabs/kaolin) - 3D deep learning library
- [NVIDIA/tiny-cuda-nn](https://github.com/NVlabs/tiny-cuda-nn) - Lightning-fast neural networks
...
- [anthropics/anthropic-cookbook](https://github.com/anthropics/anthropic-cookbook) - Recipes & examples
- [anthropics/courses](https://github.com/anthropics/courses) - AI courses & tutorials
- [anthropics/prompt-eng-interactive-tutorial](https://github.com/anthropics/prompt-eng-interactive-tutorial) - Prompt engineering
...
### 🔵 OpenAI
- [openai/openai-python](https://github.com/openai/openai-python) - Python API library
- [openai/openai-cookbook](https://github.com/openai/openai-cookbook) - Usage examples
...
- [openai/gpt-2](https://github.com/openai/gpt-2) - GPT-2 model

### 🔵 META (LLaMA & PyTorch)
- [meta-llama/llama](https://github.com/meta-llama/llama) - LLaMA models
- [meta-llama/llama3](https://github.com/meta-llama/llama3) - LLaMA 3 models
- [meta-llama/llama-stack](https://github.com/meta-llama/llama-stack) - LLaMA tooling
...
- [facebookresearch/detectron2](https://github.com/facebookresearch/detectron2) - Object detection
...
- [google/generative-ai-docs](https://github.com/google/generative-ai-docs) - Gemini docs
- [google/generative-ai-python](https://github.com/google/generative-ai-python) - Python SDK
- [tensorflow/tensorflow](https://github.com/tensorflow/tensorflow) - ML framework
- [google-deepmind/deepmind-research](https://github.com/google-deepmind/deepmind-research) - Research papers & code
- [google/jax](https://github.com/google/jax) - High-performance ML library
- [google-research/bert](https://github.com/google-research/bert) - BERT model

### 🟦 Perplexity AI
- [perplexityai/api-cookbook](https://github.com/perplexityai/api-cookbook) - API examples
- [perplexityai/modelcontextprotocol](https://github.com/perplexityai/modelcontextprotocol) - MCP implementation

### 💳 Capital One (Enterprise ML)
- [capitalone/federated-model-aggregation](https://github.com/capitalone/federated-model-aggregation) - Federated learning
- [capitalone/datacompy](https://github.com/capitalone/datacompy) - DataFrame comparison
- [capitalone/rubicon-ml](https://github.com/capitalone/rubicon-ml) - ML experiment tracking
...
- [langgenius/dify](https://github.com/langgenius/dify) - LLM app development platform
- [crewAIInc/crewAI](https://github.com/crewAIInc/crewAI) - Multi-agent AI framework
...
- [Significant-Gravitas/AutoGPT](https://github.com/Significant-Gravitas/AutoGPT) - Autonomous GPT-4
...
- [mlflow/mlflow](https://github.com/mlflow/mlflow) - End-to-end ML lifecycle
- [kubeflow/kubeflow](https://github.com/kubeflow/kubeflow) - ML workflows on Kubernetes
- [iterative/dvc](https://github.com/iterative/dvc) - Data version control
- [Netflix/metaflow](https://github.com/Netflix/metaflow) - Human-centric ML workflows
- [SeldonIO/seldon-core](https://github.com/SeldonIO/seldon-core) - ML deployment on Kubernetes
- [allegroai/clearml](https://github.com/allegroai/clearml) - Auto-magical MLOps
- [iterative/cml](https://github.com/iterative/cml) - CI/CD for ML
- [jozu-ai/kitops](https://github.com/jozu-ai/kitops) - MLOps handoffs toolkit
- [zenml-io/zenml](https://github.com/zenml-io/zenml) - Extensible MLOps framework
- [feast-dev/feast](https://github.com/feast-dev/feast) - Feature store
- [bentoml/BentoML](https://github.com/bentoml/BentoML) - ML model serving

### Hyperparameter Optimization
- [optuna/optuna](https://github.com/optuna/optuna) - Hyperparameter optimization
- [scikit-optimize/scikit-optimize](https://github.com/scikit-optimize/scikit-optimize) - Sequential model-based optimization
- [autonomio/talos](https://github.com/autonomio/talos) - Keras hyperparameter tuning
- [ray-project/ray](https://github.com/ray-project/ray) - Distributed compute framework

### Model Serving & Deployment
- [vllm-project/vllm](https://github.com/vllm-project/vllm) - Fast LLM inference
- [pytorch/serve](https://github.com/pytorch/serve) - PyTorch model serving
- [kserve/kserve](https://github.com/kserve/kserve) - Serverless ML inference
- [onnx/onnx](https://github.com/onnx/onnx) - Open Neural Network Exchange
- [tensorflow/serving](https://github.com/tensorflow/serving) - TensorFlow model serving

### Distributed Training
- [microsoft/DeepSpeed](https://github.com/microsoft/DeepSpeed) - Deep learning optimization
- [horovod/horovod](https://github.com/horovod/horovod) - Distributed training framework
- [hpcaitech/ColossalAI](https://github.com/hpcaitech/ColossalAI) - Large-scale AI training

### Model Fine-tuning
- [hiyouga/LLaMA-Factory](https://github.com/hiyouga/LLaMA-Factory) - LLM fine-tuning toolkit
- [huggingface/peft](https://github.com/huggingface/peft) - Parameter-efficient fine-tuning

### Vector Databases (RAG)
- [milvus-io/milvus](https://github.com/milvus-io/milvus) - Vector database for AI
- [chroma-core/chroma](https://github.com/chroma-core/chroma) - AI-native embedding database
- [qdrant/qdrant](https://github.com/qdrant/qdrant) - Vector similarity search
- [weaviate/weaviate](https://github.com/weaviate/weaviate) - Vector search engine
- [pgvector/pgvector](https://github.com/pgvector/pgvector) - PostgreSQL vector extension

### Model Optimization
- [ggerganov/llama.cpp](https://github.com/ggerganov/llama.cpp) - LLM inference in C/C++
- [IST-DASLab/gptq](https://github.com/IST-DASLab/gptq) - Model quantization
- [TimDettmers/bitsandbytes](https://github.com/TimDettmers/bitsandbytes) - 8-bit optimizers

### MLOps Learning Resources
- [kelvins/awesome-mlops](https://github.com/kelvins/awesome-mlops) - Curated MLOps list
- [visenger/awesome-mlops](https://github.com/visenger/awesome-mlops) - MLOps resources
- [GokuMohandas/Made-With-ML](https://github.com/GokuMohandas/Made-With-ML) - Production ML
...
- [keephq/keep](https://github.com/keephq/keep) - Open-source AIOps & alert management
- [microsoft/AIOpsLab](https://github.com/microsoft/AIOpsLab) - Autonomous AIOps agents
- [OpsPAI/awesome-AIOps](https://github.com/OpsPAI/awesome-AIOps) - Curated AIOps resources

### Anomaly Detection & Root Cause Analysis
- [logpai/loglizer](https://github.com/logpai/loglizer) - Log-based anomaly detection
- [alibaba/SREWorks](https://github.com/alibaba/SREWorks) - Cloud-native AIOps platform
- [linkedin/luminol](https://github.com/linkedin/luminol) - Anomaly detection library
- [numenta/nupic](https://github.com/numenta/nupic) - Intelligent computing platform
- [earthgecko/skyline](https://github.com/earthgecko/skyline) - Real-time anomaly detection

### Additional AIOps Tools
- [NetManAIOps/OmniAnomaly](https://github.com/NetManAIOps/OmniAnomaly) - Multivariate anomaly detection
- [NetManAIOps/DeepTraLog](https://github.com/NetManAIOps/DeepTraLog) - Deep learning for log analysis
- [logpai/loghub](https://github.com/logpai/loghub) - Log datasets for research
...
### SAST/DAST Tools
- [returntocorp/semgrep](https://github.com/returntocorp/semgrep) - Static analysis tool
- [trufflesecurity/trufflehog](https://github.com/trufflesecurity/trufflehog) - Secret scanner
- [aquasecurity/trivy](https://github.com/aquasecurity/trivy) - Vulnerability scanner
- [zaproxy/zaproxy](https://github.com/zaproxy/zaproxy) - Web app security scanner
- [bridgecrewio/checkov](https://github.com/bridgecrewio/checkov) - IaC security scanner

### Kubernetes Security
- [aquasecurity/kube-bench](https://github.com/aquasecurity/kube-bench) - K8s CIS benchmark
- [aquasecurity/kube-hunter](https://github.com/aquasecurity/kube-hunter) - K8s penetration testing
- [falcosecurity/falco](https://github.com/falcosecurity/falco) - Runtime security

### Container Security
- [docker/docker-bench-security](https://github.com/docker/docker-bench-security) - Docker security audit
...
- [elastic/elasticsearch](https://github.com/elastic/elasticsearch) - Search & analytics
- [openobserve/openobserve](https://github.com/openobserve/openobserve) - Observability platform
...
### AWS Tools
- [aws/aws-cli](https://github.com/aws/aws-cli) - AWS command line interface
- [aws/aws-cdk](https://github.com/aws/aws-cdk) - Cloud Development Kit
- [localstack/localstack](https://github.com/localstack/localstack) - Local AWS cloud stack

### Azure Tools
- [Azure/azure-cli](https://github.com/Azure/azure-cli) - Azure command line
- [Azure/azure-sdk-for-python](https://github.com/Azure/azure-sdk-for-python) - Python SDK

### Infrastructure as Code
- [hashicorp/terraform](https://github.com/hashicorp/terraform) - Infrastructure automation
- [pulumi/pulumi](https://github.com/pulumi/pulumi) - Modern IaC
- [ansible/ansible](https://github.com/ansible/ansible) - IT automation

### Multi-Cloud Management
- [gruntwork-io/terragrunt](https://github.com/gruntwork-io/terragrunt) - Terraform wrapper
- [terraform-linters/tflint](https://github.com/terraform-linters/tflint) - Terraform linter
...
### Cisco DX NetOps & SMARTS
- [Cisco Network Observability Stack (~225 repos)](https://github.com/orgs/CiscoDevNet/repositories)

### OpenTelemetry & Observability
- [open-telemetry/opentelemetry-collector](https://github.com/open-telemetry/opentelemetry-collector) - Telemetry data collection
- [open-telemetry/opentelemetry-python](https://github.com/open-telemetry/opentelemetry-python) - Python instrumentation
- [open-telemetry/opentelemetry-go](https://github.com/open-telemetry/opentelemetry-go) - Go instrumentation

### ScienceLogic Observability
- [ScienceLogic Organization Repos](https://github.com/orgs/ScienceLogic/repositories)
...
### Service Mesh
- [istio/istio](https://github.com/istio/istio) - Service mesh platform
- [linkerd/linkerd2](https://github.com/linkerd/linkerd2) - Lightweight service mesh

### Network Tools
- [nicolaka/netshoot](https://github.com/nicolaka/netshoot) - Network troubleshooting toolkit
- [mehrdadrad/tcpdog](https://github.com/mehrdadrad/tcpdog) - TCP observability
...
- [kubernetes/minikube](https://github.com/kubernetes/minikube) - Local Kubernetes
- [k3s-io/k3s](https://github.com/k3s-io/k3s) - Lightweight Kubernetes

### GitOps
- [argoproj/argo-cd](https://github.com/argoproj/argo-cd) - Declarative GitOps
- [fluxcd/flux2](https://github.com/fluxcd/flux2) - GitOps toolkit

### Service Mesh
- [istio/istio](https://github.com/istio/istio) - Connect, secure, control services
- [linkerd/linkerd2](https://github.com/linkerd/linkerd2) - Ultralight service mesh

### Storage
- [rook/rook](https://github.com/rook/rook) - Cloud-native storage
- [longhorn/longhorn](https://github.com/longhorn/longhorn) - Distributed block storage
...
- [llvm/circt](https://github.com/llvm/circt) - Circuit IR compilers
- [ROCm-Developer-Tools/llvm-project](https://github.com/ROCm-Developer-Tools/llvm-project) - AMD ROCm LLVM

### Top C++ Projects
- [tensorflow/tensorflow](https://github.com/tensorflow/tensorflow) - ML framework
- [opencv/opencv](https://github.com/opencv/opencv) - Computer vision library
- [ggml-org/llama.cpp](https://github.com/ggml-org/llama.cpp) - LLM inference in C/C++
- [electron/electron](https://github.com/electron/electron) - Desktop apps with web tech
- [godotengine/godot](https://github.com/godotengine/godot) - Game engine
- [bitcoin/bitcoin](https://github.com/bitcoin/bitcoin) - Bitcoin Core
- [grpc/grpc](https://github.com/grpc/grpc) - High-performance RPC
- [protocolbuffers/protobuf](https://github.com/protocolbuffers/protobuf) - Protocol Buffers
- [ocornut/imgui](https://github.com/ocornut/imgui) - Immediate mode GUI
- [nlohmann/json](https://github.com/nlohmann/json) - JSON for Modern C++
- [google/googletest](https://github.com/google/googletest) - Testing framework

### Top Go Projects
- [kubernetes/kubernetes](https://github.com/kubernetes/kubernetes) - Container orchestration
- [ollama/ollama](https://github.com/ollama/ollama) - Run LLMs locally
- [golang/go](https://github.com/golang/go) - The Go language
- [prometheus/prometheus](https://github.com/prometheus/prometheus) - Monitoring system
...
- [etcd-io/etcd](https://github.com/etcd-io/etcd) - Distributed key-value store
- [moby/moby](https://github.com/moby/moby) - Docker
- [traefik/traefik](https://github.com/traefik/traefik) - Cloud Native proxy

### gRPC Ecosystem
- [grpc/grpc-go](https://github.com/grpc/grpc-go) - gRPC for Go
- [grpc/grpc-java](https://github.com/grpc/grpc-java) - gRPC for Java
- [grpc/grpc-web](https://github.com/grpc/grpc-web) - gRPC for browsers
- [grpc-ecosystem/grpc-gateway](https://github.com/grpc-ecosystem/grpc-gateway) - REST to gRPC
- [fullstorydev/grpcui](https://github.com/fullstorydev/grpcui) - Interactive gRPC UI

### Modern C++ Frameworks
- [abseil/abseil-cpp](https://github.com/abseil/abseil-cpp) - C++ library supplement
- [microsoft/vcpkg](https://github.com/microsoft/vcpkg) - C++ package manager
- [gabime/spdlog](https://github.com/gabime/spdlog) - Fast C++ logging
- [fmtlib/fmt](https://github.com/fmtlib/fmt) - Modern formatting
- [catchorg/Catch2](https://github.com/catchorg/Catch2) - Testing framework
...
### Web Frameworks
- [django/django](https://github.com/django/django) - High-level web framework
- [pallets/flask](https://github.com/pallets/flask) - Micro web framework
- [fastapi/fastapi](https://github.com/fastapi/fastapi) - Modern API framework
- [encode/starlette](https://github.com/encode/starlette) - ASGI framework

### CLI Tools
- [Textualize/rich](https://github.com/Textualize/rich) - Rich text in terminal
- [fastapi/typer](https://github.com/fastapi/typer) - CLI library
- [pallets/click](https://github.com/pallets/click) - Command line interface
- [Textualize/textual](https://github.com/Textualize/textual) - TUI framework

### Testing
- [pytest-dev/pytest](https://github.com/pytest-dev/pytest) - Testing framework
- [HypothesisWorks/hypothesis](https://github.com/HypothesisWorks/hypothesis) - Property-based testing

### Code Quality
- [astral-sh/ruff](https://github.com/astral-sh/ruff) - Extremely fast linter
- [psf/black](https://github.com/psf/black) - Code formatter
- [python/mypy](https://github.com/python/mypy) - Static type checker

### Package Management
- [python-poetry/poetry](https://github.com/python-poetry/poetry) - Dependency management
- [astral-sh/uv](https://github.com/astral-sh/uv) - Extremely fast package installer
- [pdm-project/pdm](https://github.com/pdm-project/pdm) - Modern package manager

### Data Validation
- [pydantic/pydantic](https://github.com/pydantic/pydantic) - Data validation
- [python-attrs/attrs](https://github.com/python-attrs/attrs) - Classes without boilerplate
...
### SciPy Conference
- [scipy-conference Organization](https://github.com/scipy-conference) - ~33 repos
- [scipy/scipy](https://github.com/scipy/scipy) - Scientific computing
...
- [matplotlib/matplotlib](https://github.com/matplotlib/matplotlib) - Visualization
- [scikit-learn/scikit-learn](https://github.com/scikit-learn/scikit-learn) - Machine learning
- [jupyter/notebook](https://github.com/jupyter/notebook) - Interactive notebooks

### KubeCon Resources
- KubeCon-CloudNativeCon-Europe-2019 presentations
- KubeCon-North-America-2018 presentations
...
- [Broadcom/ca-apm-fieldpack-asm](https://github.com/Broadcom/ca-apm-fieldpack-asm) - APM monitoring
- [CA-APM Organization](https://github.com/CA-APM) - Application Performance Management
- [CA DevTest](https://github.com/topics/ca-devtest) - Testing solutions
- [View all Broadcom/CA repos](https://github.com/orgs/Broadcom/repositories)
...
Use the Quick Jump Menu above to navigate to your area of interest.

### 2. Direct Search on GitHub
- Visit [Your Stars](https://github.com/nbajpai-code?tab=stars)
- Use GitHub's search: `language:python` or `topic:kubernetes`

### 3. Filter by Language
- **Python:** [Filter](https://github.com/nbajpai-code?tab=stars&language=python)
- **Go:** [Filter](https://github.com/nbajpai-code?tab=stars&language=go)
- **JavaScript:** [Filter](https://github.com/nbajpai-code?tab=stars&language=javascript)
- **C++:** [Filter](https://github.com/nbajpai-code?tab=stars&language=c++)

### 4. Sort Options
On GitHub stars page, you can sort by:
- Recently starred
- Recently active
- Most stars
...
- [⭐ View All Stars](https://github.com/nbajpai-code?tab=stars)
- [👤 My Profile](https://github.com/nbajpai-code)
